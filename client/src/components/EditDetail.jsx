...
const EditDetail = ({ address, paymethod, trackingNo, trackmethod, setPaymethod, settrackmethod, setAddress, settrackingNo, backClick, submitEditDetail }) => {
  ...
  if (loading) {
    return <div style={{ marginTop: '20%' }}><center><Loader /></center></div>
  } else {
    return (
